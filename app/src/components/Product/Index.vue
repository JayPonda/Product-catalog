        ...
        >
            ...
            <template #cell-actions="{ item }">
                <div class="relative text-right">
                    <button @click="toggleMenu(item.id)" aria-label="Product actions"
                    ...
                    <!-- click-away layer -->
                    <div v-if="openMenuId === item.id" class="fixed inset-0 z-60"
                    ...
                    <div v-if="openMenuId === item.id"
                        ...
                        <button @click="addCategories(item)"
...
function next() {
    ...
    if (product.total !== undefined && product.limit !== undefined && product.offset !== undefined && product.total - (product.limit * (product.offset + 1)) > 0) {
