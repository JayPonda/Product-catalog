    ...
    <div class="w-full max-w-md space-y-6 rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <form class="space-y-4" @submit.prevent="submit">
        ...
        <div>
          ...
          <div class="relative">
            <input id="password" :type="showPassword ? 'text' : 'password'" v-model="form.password" autocomplete="current-password"
      ...
      <p class="text-center text-sm text-gray-500">
        No account?
        <RouterLink to="/register" class="font-medium text-emerald-700 hover:underline">Create one</RouterLink>
      </p>
    </div>
  </div>
</template>
